...
const Entries =() =>{
    ...
    const [newEntry, setNewEntry] = useState({"dish":"", "ingredients":"", "calories":0, fat:0, carbohydrates: 0, protein: 0})
            ...
            <Modal show={addNewEntry} onHide={() => setAddNewEntry(false)} centred>
                ...
                <Modal.Body>
                    <Form.Group>
                        ...
                        <Form.Control type="number" onChange={(event) => {newEntry.carbohydrates = event.target.value}}></Form.Control>
                        <Form.Label>protein</Form.Label>
                        <Form.Control type="number" onChange={(event) => {newEntry.protein = event.target.value}}></Form.Control>
                    </Form.Group>
    ...
    function addSingleEntry(){
        ...
        axios.post(url, {
            ...
            "carbohydrates": parseFloat(newEntry.carbohydrates),
